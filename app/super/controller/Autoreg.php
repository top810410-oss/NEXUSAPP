...
use app\im\model\mysql\AutoReg as DB_AutoReg;
...
class Autoreg extends Controller
{
    ...
    public function index()
    {
      ...
      $findArr = DB_AutoReg::where(['id'=>'1'])->select();
        ...
        $ret = DB_System::where(['key' => 'action_auto_reg'])->find();
        if($ret){
    ...
    public function updateAutoReg(){
       ...
       $where =  ['id' => 1 ];
       $res_obj = DB_AutoReg::where($where)->find();
       if($res_obj){
           $update = [
            'url' => $post_data['url'],
          ...
          $ret  = DB_AutoReg::where($where)->update($update);
           if($ret !== false)
        { 
             $return_data['err'] = 0;
    ...
    public function edit()
    {
        ...
        $res = DB_AutoReg::where($where)->find();
        $return_data['err'] = 0;
